     ...
     <div class="index-content">
      ...
      @foreach($cate as $k=>$v)
       <div class="radio-type-cpt">
        <a href="/home/ting/{{$v->id}}/edit"><img src="{{ $v->path or '/uploads/images/af0PCkr3GnFcFqAEcH5Ri00fN5DhPDLhR77ZA7St.png' }}" width="25px" />{{ $v->name}}</a>
       </div>
       @endforeach
      </div> 
<!-- 电台推荐 -->
            ...
            <div class="ting-cpt">
             ...
             <div class="ting-info">
              ...
              <div class="ting-author">
               <a href="/home/personal/{{ $v->User->id }}" target="_blank">主播&nbsp;/&nbsp;{{ $v->User->nickname }}</a>
              </div> 
